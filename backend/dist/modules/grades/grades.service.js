...
let GradesService = class GradesService {
    ...
    async create(matriculaId, valor, rubrica, feedback) {
        return this.prisma.calificacion.create({ data: { matriculaId, valor, rubrica, feedback } });
    }
    async listByMatricula(matriculaId) {
